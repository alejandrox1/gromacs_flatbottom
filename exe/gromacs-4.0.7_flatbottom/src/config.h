...
#define BUILD_MACHINE "Linux 3.10.73-1.el6.elrepo.x86_64 x86_64"

/* Date and time for build */
#define BUILD_TIME "Tue Jul 14 16:27:55 PDT 2015"

/* User doing build */
#define BUILD_USER "alarcj@comet-ln2.sdsc.edu"
